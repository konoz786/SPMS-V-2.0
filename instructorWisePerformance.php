  ...
  <body>
      ...
      <div class="row1">
        <form method="POST">
         ...
         <div style="height:50px;padding-left:46%;margin-top:15px;">
      ...
      <button onclick="viewInstructorWise()" style="height: 46px;width: 100px;margin-left:50px;display:inline-block; border-radius: 10px; border: none;outline: none;background:Black;color: #fff;font-size: 14px;letter-spacing:2px;text-transform: uppercase;cursor:pointer;font-weight: bold;">
        view</button>
      </div>
