...
ul {
  ...
  <div ></div>
          ...
          <li><a href="ploAchieveStats.php" target="_self">ploAcheiveStatus</a></li>
...
<div class="background">
     ...
     <input style="background-color:Black;height:36px;border: 1px solid;cursor: pointer;border-radius: 5px;
     ...
     <select style="margin-left:10px;" name="year" class="select">
       ...
       <input style="background:Black;border-radius:15px;border:none;outline:none;color:#fff;font-size:14px;letter-spacing:2px;
        ...
        <button onclick="view()" style="height: 36px;width: 100px;margin-left:40px;display:inline-block;border-radius: 10px;
        border: none;outline: none;background:#violet;color:Black;font-size: 14px;letter-spacing:2px;
