    ...
    <div class="nav">
     ...
     <!--   <div class="nav-btn"> -->
      <h2>SPMS V 2.0</h2>
        ...
        <div class="nav-links">
            <ul>
            <li><a href="employee_dashboard.php" target="_self">Return to Empolyee Dashboard</a></li>
...
<div class="background">
      ...
      <div style="height:80px;"class="row1">
        <form method="POST">
        <input style="background-color:Black;height:20px;border: 1px solid;cursor: pointer;border-radius: 5px;font-size: 14px;letter-spacing:2px;
        ...
        <input style="background:Black;border-radius:10px; border:none;outline:none;color:#fff;font-size:14px;
