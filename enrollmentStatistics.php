...
<div style="display:flex;justify-content:center;" class="row1">
    ...
    <form method="POST">
     <select style="margin-left:10px;" name="year" class="select">
       ...
       <input style="background:Black;border-radius:10px;border:none;outline:none;color:#fff;font-size:14px;letter-spacing:2px;
    ...
    <div class="background">
      <div class="row2">
        <button style="margin-bottom:0px;" onclick="schoolWiseEnrollment()" class="School-wise">School-wise</button><br><br>
        <button onclick="departmentWiseEnrollment()" class="Department-wise">Department-wise</button><br><br>
        <button onclick="programWiseEnrollment()" class="Program-wise">Program-wise</button>
          ...
          <div style="width:1000px; margin:auto; margin-top:20px;">     
             <div id="piechart" style="width: 1000px; height: 530px; background-color:Green;"></div>  
          </div>
  </div>
