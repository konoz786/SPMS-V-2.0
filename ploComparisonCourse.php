...
<div class="background">
     ...
     <select style="margin-left:10px;" name="year" class="select">
       ...
       <input style="background:#00BFFF;border-radius:10px;border:none;outline:none;color:#fff;font-size:14px;letter-spacing:2px;
              text-transform:uppercase;cursor:pointer;font-weight:bold;margin-left:10px;height: 30px;width: 100px;"
        ...
        <button onclick="view()" style="height: 30px;width: 100px;margin-left:40px;display:inline-block;border-radius: 10px;
